"""
Django settings for twilio_login project.
...
SECRET_KEY = 'django-insecure-6v$1-2s4od_@c^=%z$0ih3vc-0%9ohbi^tv9)vv&=7tzpzo8__'
...
ROOT_URLCONF = 'twilio_login.urls'
...
WSGI_APPLICATION = 'twilio_login.wsgi.application'
